...
export default {
  ...
  '选择 {name}': 'Select {name}',
  '管理 {name}': 'Manage {name}',
  '先导入多个片段': 'Import several clips first',
  '1. 上传视频或图片': '1. Upload videos or images',
  '2. 在对话里排列和修剪': '2. Order and trim them in chat',
  '3. 在预览里播放': '3. Play the preview',
  '4. 导出 MP4': '4. Export an MP4',
  '导入片段': 'Import clips',
  '也可以把文件拖到这个面板。': 'You can also drop files on this panel.',
  '拖入多个片段': 'Drop several clips',
  '视频和图片会进入素材库并接到时间线。然后在对话里排列、修剪、导出。': 'Videos and images go into the media pool and onto the timeline. Then order, trim, and export them in chat.',
